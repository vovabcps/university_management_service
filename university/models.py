...
class SystemUser(models.Model):
    ...
    def get_rooms(self):
        return [room.room_number for room in self.rooms.all()]
...
class Subject(models.Model):
    ...
    regente = models.OneToOneField(SystemUser, on_delete=models.SET_NULL,
                                   null=True)  # o regente da cadeira tem q dar aulas dessa cadeira
