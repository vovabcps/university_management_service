...
class PersonalInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ["id", "get_systemUser_user", "name", "personal_email", "gender", "nationality", "birth_date",
                    "vat_number"]
...
class SystemUserSubjectAdmin(admin.ModelAdmin):
    ...
    list_display = ["id", "get_systemUser_user", "get_subject_name", "subjSemestre", "state", "grade", "turmas",
                    "get_anoLetivo"]
...
class LessonAdmin(admin.ModelAdmin):
    ...
    list_display = ["id", "get_subject_name", "type", "turma", "week_day", "hour", "duration", "professor_fc",
                    "room_number", "is_open"]
